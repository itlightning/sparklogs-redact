...
All notable changes to `@sparklogs/redact-cli` are documented here. This project adheres to
...
- **README**: consumer-focused docs; `npm install` / `npx sparklogs-redact` quick start (no monorepo build copy).
